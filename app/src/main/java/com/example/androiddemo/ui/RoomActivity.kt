...
import com.example.androiddemo.viewmodel.RoomViewModel
...
class RoomActivity : AppCompatActivity() {
    ...
    private val mViewModel:RoomViewModel by lazy { ViewModelProvider(this)[RoomViewModel::class.java] }
    ...
    private fun initClick() {
        btn_insert.setOnClickListener {
            ...
            roomAdd.setOnClickListener {
                val user = User(roomName.text.toString(), roomAge.text.toString(), roomQQ.text.toString().toLong())
                thread {
